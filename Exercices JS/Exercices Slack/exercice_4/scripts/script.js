...
alert("Bienvenue sur l'application des impôts de Zorglub, ensemble nous allons vérifier si vous êtes imposable ou non");
...
if ((s_Sexe == "M" && i_Age > 20) || (s_Sexe == "F" && i_Age >= 18 && i_Age <= 35)) {
    alert("Félicitation, vous êtes imposable");
    
}
// Sinon dans tous les autres cas affiche "Malheureusement, vous n'êtes pas imposable."
else {
    alert("Malheureusement, vous n'êtes pas imposable ou la saisie que vous avez effectuée est incorrecte.");
